...
class Camera_Configuration:
    def __init__(self, master=None):
        ...
        self.Button1.place(relx=0.6,rely=0.04,height=28,width=102)
        ...
        self.Button2.place(relx=0.28,rely=0.83,height=28,width=124)
        ...
        self.Checkbutton1.place(relx=0.39,rely=0.04,relheight=0.12
                ,relwidth=0.18)
        ...
        self.Frame1.place(relx=0.04,rely=0.04,relheight=0.12,relwidth=0.33)
        ...
        self.Label1.place(relx=0.0,rely=0.1,height=21,width=47)
        ...
        self.Spinbox1.place(relx=0.58,rely=0.17,relheight=0.63,relwidth=0.35)
        ...
        self.Label2.place(relx=0.04,rely=0.09,height=24,width=32)
        ...
        self.TCombobox1.place(relx=0.57,rely=0.09,relheight=0.15,relwidth=0.38)
        ...
        self.Label7.place(relx=0.04,rely=0.31,height=24,width=76)
        ...
        self.TCombobox2.place(relx=0.57,rely=0.31,relheight=0.15,relwidth=0.38)
        ...
        self.Label4.place(relx=0.04,rely=0.53,height=24,width=109)
        ...
        self.TCombobox3.place(relx=0.57,rely=0.53,relheight=0.15,relwidth=0.38)
        ...
        self.Label5.place(relx=0.04,rely=0.74,height=24,width=93)
        ...
        self.TCombobox5.place(relx=0.57,rely=0.74,relheight=0.15,relwidth=0.38)
        ...
        self.TCombobox5.configure(textvariable=Configuration_support.Focus) # must change it into something else
        self.TCombobox5.configure(takefocus="")


        self.Label6 = Label (self.Frame2)
        self.Label6.place(relx=0.04,rely=0.95,height=24,width=93)
        ...
        self.TCombobox4.place(relx=0.57,rely=0.95,relheight=0.15,relwidth=0.38)
        self.value_list = ['Daylight','Shadow','Cloudy','Tungsten','Fluorescent', 'Flash', 'Manual']
        self.TCombobox4.configure(values=self.value_list)
        self.TCombobox4.configure(textvariable=Configuration_support.Focus)#Must add the Function
