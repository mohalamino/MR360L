...
def getconfig():
        os.system("sudo python /mnt/PiPics/GetConfig.py")
...
##                print "Command: "+ rcv
	...
	if rcv == "reboot":
		...
		pid = subprocess.call(cmd, shell=True) 
                ...
                config()
        elif rcv == "configure"+rpi_id:
                config()
        elif rcv == "getConfigure"+rpi_id:
                getconfig()
        elif rcv == "ledoff":
                mpuWithTolera.LEDCON(LEDx,0)
                mpuWithTolera.LEDCON(LEDy,0)
                #mpuWithTolera.LEDCON(7,0)
        elif rcv == "calibrate":
##                if Senava == -1:
##                        print " No Sensor "
##                else:
