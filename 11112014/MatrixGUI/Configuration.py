...
w = None
def create_Camera_Configuration (root, param=None):
...
class Camera_Configuration:
    def __init__(self, master=None):
        ...
        self.value_list = ['6400','3200','1600','800','400','200',]
        ...
        self.value_list = ['6.4','5','4.5','4','3.2','1.7',]
        ...
        self.value_list = ['0.5','1/40','1/100','1/200','1/4000',]
        ...
        self.Label5.configure(text='''Focus Mode''')

        #Focus Mode Values
        self.TCombobox4 = ttk.Combobox (self.Frame2)
        self.TCombobox4.place(relx=0.57,rely=0.74,relheight=0.15,relwidth=0.38)
        self.value_list = ['One Shot','AI Servo','AI Focus',]
        self.TCombobox4.configure(values=self.value_list)
        self.TCombobox4.configure(textvariable=Configuration_support.Focus)
